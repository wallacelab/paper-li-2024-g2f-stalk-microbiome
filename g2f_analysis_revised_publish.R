...
otu_table	=	read.table("/home/hl46161/new_G2F_dada2/exported_table/dada2_table-no-mitochondria-no-chloroplast.txt",row.names =1,check.names = FALSE,sep="\t",skip=1,header = TRUE)
...
taxonomy = read.csv("/home/hl46161/new_G2F_dada2/exported_table_phyloseq/taxonomy.tsv",sep="\t",row.names =1)
...
phy_tree	=	read_tree("/home/hl46161/new_G2F_dada2/exported_table_phyloseq/tree.nwk")

#import metadata table and convert to matrix 
metadata	=	read.table("/home/hl46161/new_G2F_dada2/G2f_2019_sub_corrected_metadata.tsv",sep ="\t",header = 1,row.names=1)
...
ggsave("/home/hl46161/publish_2019_G2F_dada2/shannon_plot_location_rerun.png", height=10, width=10, device="png")
...
ggsave("/home/hl46161/publish_2019_G2F_dada2/Observed_plot_location_rerun.png", height=10, width=10, device="png")
...
ggsave("/home/hl46161/publish_2019_G2F_dada2/shannon_plot_pedigree_rerun.png", height=10, width=10, device="png")
...
ggsave("/home/hl46161/publish_2019_G2F_dada2/Observed_plot_pedigree_rerun.png", height=10, width=10, device="png")
...
ggsave("/home/hl46161/publish_2019_G2F_dada2/alpha_diversity_plot_location_pedigree_rerun.png", height=9, width=12, device="png")

#alpha_diversity_plot_location <- ggarrange(Shannon_location,Observed_location,nrow = 1,ncol = 2)
#alpha_diversity_plot_location
#ggsave("/home/hl46161/publish_2019_G2F_dada2/alpha_diversity_plot_location_rerun.png", height=9, width=12, device="png")
...
table(G2F_metadata_2019_duplicate_pedigree_ys_filtered$location,G2F_metadata_2019_duplicate_pedigree_ys_filtered$Corrected_pedigree)
...
#alpha_result <- dplyr::bind_rows(alpha_result,lm_chaos_result)
alpha_result <- dplyr::bind_rows(alpha_result,lm_simpson_list)

#alpha_result$total_variance_explained <- alpha_result$location + alpha_result$pedigree + alpha_result$`G*E`
#alpha_result <- as.data.frame(alpha_result)
#alpha_result <- t(alpha_result)
#colnames(alpha_result) <- c("observed_features","shannon","chaos1","simpson")

alpha_result

#alpha_result$test_var <- as.character(alpha_result$test_var)
#alpha_result$test_var[alpha_result$test_var == "location"] <- "Environment"
#alpha_result$test_var[alpha_result$test_var == "pedigree"] <- "Maize genotype"
#alpha_result$test_var[alpha_result$test_var == "G*E"] <- "GXE"
...
#output the graph
ggsave("/home/hl46161/publish_2019_G2F_dada2/alpha_diversity_GXE_2.png", height=10, width=12, device="png")
...
weighted_unifrac <- read_qza("/home/hl46161/new_G2F_dada2/core-metrics-results-dada2_table-no-mitochondria-no-chloroplast-blank-filtered-yellow-stripe-duplicate-pedigree-1500/weighted_unifrac_pcoa_results.qza")
unweighted_unifrac <- read_qza("/home/hl46161/new_G2F_dada2/core-metrics-results-dada2_table-no-mitochondria-no-chloroplast-blank-filtered-yellow-stripe-duplicate-pedigree-1500/unweighted_unifrac_pcoa_results.qza")
...
G2F_Metadata_2019	=	read.table("/home/hl46161/new_G2F_dada2/G2f_2019_sub_corrected_metadata_no_blank.tsv",sep ="\t",header = 1)
...
ggsave("/home/hl46161/publish_2019_G2F_dada2/beta_diversity_weighted_unifrac.png", height=10, width=10, device="png")
...
#alpha_beta_GXE_plot <- ggarrange(alpha_diversity_GXE_plot,beta_diversity_GXE_plot,ncol = 2,
#common.legend = TRUE,legend = "bottom",labels = c("A", "B"),
#font.label = list(size = 25, color = "black"))
#alpha_beta_GXE_plot


ggsave("/home/hl46161/publish_2019_G2F_dada2/alpha_beta_diversity_weighted_unifrac.png", height=10, width=12, device="png")
...
location_core_microbiome <- function(taxonomic_level,prevalence_level){
  ...
  for(experiment_field in unique(G2F_metadata_2019_duplicate_pedigree_ys_filtered_selected_location$location)){
    ...
    #create read path
    directory_name = paste("/home/hl46161/new_G2F_dada2/core-metrics-results-dada2_table-no-mitochondria-no-chloroplast-blank-filtered-yellow-stripe-duplicate-pedigree-",experiment_field,"-1500",sep="")
...
ggsave("/home/hl46161/publish_2019_G2F_dada2/location_family_core_microbiome_heatmap.png",plot = location_family_core_microbiome_heatmap,core_taxa_plot,height=8, width=12, device="png")
...
for(pedigree in unique(G2F_metadata_2019_duplicate_pedigree_ys_filtered_selected_location$Corrected_pedigree)){
  ...
  print(pedigree)
  #create read path
  directory_name = paste("/home/hl46161/new_G2F_dada2/core-metrics-results-dada2_table-no-mitochondria-no-chloroplast-blank-filtered-yellow-stripe-duplicate-pedigree-",pedigree,"-1500",sep="")
  print(directory_name)
...
G2f_2019_soil_data <- read.csv("/home/hl46161/new_G2F_dada2/G2f_2019_enviromental/g2f_2019_soil_data.csv",sep = ",")
G2f_2019_weather_data <- read.csv("/home/hl46161/new_G2F_dada2/G2F_2019_weather_aervage_and_sum.tsv",sep = "\t")
...
ggsave("/home/hl46161/publish_2019_G2F_dada2/median_alpha_diversity_plot.png", height=8, width=24, device="png")
...
Relative_Humidity_distance <- read_qza("/home/hl46161/new_G2F_dada2/core-metrics-results-dada2_table-no-mitochondria-no-chloroplast-blank-filtered-yellow-stripe-duplicate-pedigree-no-NCH1-group-by-location-from-rarefied_table-18000/Relative.Humidity...._distance_matrix.qza")
Potassium_distance <- read_qza("/home/hl46161/new_G2F_dada2/core-metrics-results-dada2_table-no-mitochondria-no-chloroplast-blank-filtered-yellow-stripe-duplicate-pedigree-no-NCH1-group-by-location-from-rarefied_table-18000/Potassium.ppm.K_distance_matrix.qza")
Solar_radiation_distance <- read_qza("/home/hl46161/new_G2F_dada2/core-metrics-results-dada2_table-no-mitochondria-no-chloroplast-blank-filtered-yellow-stripe-duplicate-pedigree-no-NCH1-group-by-location-from-rarefied_table-18000/Solar.Radiation..W.m2._distance_matrix.qza")
Temperature_distance <- read_qza("/home/hl46161/new_G2F_dada2/core-metrics-results-dada2_table-no-mitochondria-no-chloroplast-blank-filtered-yellow-stripe-duplicate-pedigree-no-NCH1-group-by-location-from-rarefied_table-18000/Temperature..C._distance_matrix.qza")


location_weighted_unifrac <- read_qza("/home/hl46161/new_G2F_dada2/core-metrics-results-dada2_table-no-mitochondria-no-chloroplast-blank-filtered-yellow-stripe-duplicate-pedigree-no-NCH1-group-by-location-from-rarefied_table-18000/weighted_unifrac_distance_matrix.qza")
location_unweighted_unifrac <- read_qza("/home/hl46161/new_G2F_dada2/core-metrics-results-dada2_table-no-mitochondria-no-chloroplast-blank-filtered-yellow-stripe-duplicate-pedigree-no-NCH1-group-by-location-from-rarefied_table-18000/unweighted_unifrac_distance_matrix.qza")
...
#ggsave("/home/hl46161/publish_2019_G2F_dada2/Relative_Humidity_weighted.png", height=10, width=10, device="png")
...
ggsave("/home/hl46161/publish_2019_G2F_dada2/G2F_environment_weighted_plot.png", height=10, width=20, device="png")
...
for (genotype in unique(G2F_metadata_2019_duplicate_pedigree_ys_filtered_selected_location$Corrected_pedigree)){
  ...
  directory_name = paste("/home/hl46161/new_G2F_dada2/core-metrics-results-dada2_table-no-mitochondria-no-chloroplast-blank-filtered-yellow-stripe-duplicate-pedigree-",changed_genotype,"-by-location-3000",sep="")
  print(directory_name)
  ...
  for (environment_factor in environment_factors){
    ...
    environment_factor_name = paste("/home/hl46161/new_G2F_dada2/core-metrics-results-dada2_table-no-mitochondria-no-chloroplast-blank-filtered-yellow-stripe-duplicate-pedigree-no-NCH1-group-by-location-from-rarefied_table-18000/",environment_factor,"_distance_matrix.qza",sep="")
    ...
    if(weighted_unifrac_location_distance_mantel$signif > 0.05 | is.na(weighted_unifrac_location_distance_mantel$signif)){
      ...
      #colnames(G2F_temp_data) <- c("weighted_unifrac_distance",environment_factor)
      G2F_temp_data
      ...
      print(gg)
      save_name = paste("/home/hl46161/publish_2019_G2F_dada2/",environment_factor,"_",changed_genotype,"_weighted_unifrac.png",sep="") 
      save_name
    ...
    if(unweighted_unifrac_location_distance_mantel$signif > 0.05 | is.na(unweighted_unifrac_location_distance_mantel$signif)){
      ...
      print(gg)
      save_name = paste("/home/hl46161/publish_2019_G2F_dada2/",environment_factor,"_",changed_genotype,"_unweighted_unifrac.png",sep="") 
      save_name
      ggsave(save_name, height=10, width=10, device="png")
...
pathway_description <- read.table("/home/hl46161/new_G2F_dada2/Picrust/picrust2_out_dada2_table-no-mitochondria-no-chloroplast-blank-filtered-yellow-stripe-duplicate-pedigree/pathways_out/path_abun_unstrat_descrip.tsv",sep = "\t",header = T,check.names = T,row.names = 2)

#instead of use kegg pathway, use the pathway abundance calculated based on MetaCYC
#pathway_description <- read.table("/home/hl46161/new_G2F_dada2/Picrust/picrust2_out_rarefied_table_no_sub_pipeline_inter/pathways_out/path_abun_unstrat_descrip.tsv",sep = "\t",header = T,check.names = T,row.names = 2)
#pathway_description <- read.table("/home/hl46161/new_G2F_dada2/Picrust/picrust2_out_rarefied_table_pipeline/pathways_out/path_abun_unstrat_descrip.tsv",sep = "\t",header = T,check.names = T,row.names = 2)
...
G2F_metadata_2019_NO_sub_yellow_stripe_sub
...
#remove NCH1 data 
#average_pathway_location_metadata <- average_pathway_location_metadata[-c(9),]
...
#average_pathway_group <- average_pathway_group[-c(13),]
#pathway_location_metadata <- pathway_location_metadata[-c(13),]
...
for (environmental_name in colnames(pathway_location_metadata)){
  ...
  save_path = paste("/home/hl46161/new_G2F_dada2/massalin2/lm_ec_pathway_Massalin2_no_normalize_no_transform",environmental_name,sep="")
  print(save_path)
  #create the result 
...
pathway_description <- read.table("/home/hl46161/new_G2F_dada2/Picrust/picrust2_out_rarefied_table_pipeline/pathways_out/path_abun_unstrat_descrip.tsv",sep = "\t",header = T,check.names = T)
pathway_description <- pathway_description[,c("pathway","description")]
#keep only result have adjusted p value lower than 0.01 
...
write.table(significant_result_0.05_annotation,"/home/hl46161/new_G2F_dada2/massalin2/combined_significant_result_rerun_final.tsv",row.names = F,sep="\t")
...
write.table(significant_result_0.05_annotation_parent_pathway,"/home/hl46161/new_G2F_dada2/massalin2/combined_significant_result_rerun_final_parent_pathway.tsv",row.names = F,sep="\t")
...
#write.table(significant_result_0.01_super_class_annotation,"/home/hl46161/new_G2F_dada2/massalin2/combined_significant_result_no_normalization.tsv",row.names = F,sep="\t")
...
pathway_description <- pathway_description[,c("pathway","description")]
#keep only result have adjusted p value lower than 0.01 
significant_result_0.01_annotation <- dplyr::left_join(significant_result_0.01,pathway_description, by = c("feature" = "pathway"))
