...
ggsave(diplot, file="3_GxE/3d_MetaCyc_pathway_GXE.jgw.diagnostics.png",
...
# Save data & plots
ggsave(heritability_plot, file="3_GxE/3d_MetaCyc_pathway_GXE.jgw.png", height = 10, width = 10, device = "png")
write.csv(herits, file="3_GxE/3d_MetaCyc_pathway_GXE.jgw.csv", row.names=FALSE)
