...
# Read in the metadata to correlate with UniFrac distances
G2F_Metadata_2019 <- read.table("./G2f_2019_sub_corrected_metadata.tsv", sep = "\t", header = TRUE, row.names = 1)
...
ggsave("./beta_diversity_weighted_unifrac.png", plot = input_pcoa_plot, height = 10, width = 10, device = "png")
