...
#    Then modified from g2f_analysis_rerun_scratch.R in same folder, which seems like the acutal publication code
...
core_taxa = lapply(taxa_levels, function(t){
  #infile=paste("0_data_files/core_taxa/dada2_table-no-mitochondria-no-chloroplast-blank-filtered-YS-only-",t,"_25_filtered.qza", sep="")  # Old data
  infile=paste("0_data_files/core_taxa/dada2_table-no-mitochondria-no-chloroplast-blank-filtered-YS-only-duplicate-",t,"_20_filtered.qza", sep="")  # Newer filtering
