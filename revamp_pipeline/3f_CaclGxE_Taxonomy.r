...
write.csv(prevalence, file="3_GxE/3f_taxonomy_prevalence.csv", row.names=FALSE)
...
# Save
ggsave(core_taxa_plot, file="3_GxE/3f_taxon_GXE.png", height=8, width=12)
write.csv(herits, file="3_GxE/3f_taxon_GXE.csv", row.names=FALSE)
