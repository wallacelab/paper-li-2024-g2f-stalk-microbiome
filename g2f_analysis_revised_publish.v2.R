...
#remove NCH1-1-159 samples for missing value 
ps <- subset_samples(ps, rownames(sample_data(ps)) != "NCH1-1-159")

#rarefy the data at 1500 read depth 
...
#write.table(significant_result_0.05,"./combined_significant_result_rerun.tsv",row.names = F,sep="\t")
